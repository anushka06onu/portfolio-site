  ...
  return (
    <section id="contact" className="editorial-card editorial-card-accent p-6 sm:p-9 space-y-6 overflow-hidden">
      <div className="max-w-2xl space-y-2.5">
        <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-[var(--primary-accent-subtle)] border border-[var(--primary-accent)]/20 text-xs font-mono text-[var(--primary-accent)] font-semibold">
      ...
      <div className="flex flex-wrap items-center gap-3 pt-1 font-mono text-xs">
        <a
          ...
          className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg bg-gradient-to-r from-teal-500 to-cyan-500 hover:from-teal-400 hover:to-cyan-400 text-slate-950 font-bold shadow-md shadow-teal-500/20 transition-all"
        >
