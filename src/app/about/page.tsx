...
export const metadata: Metadata = {
  ...
  description:
    "Academic background, research background, engineering experience, skills, and curriculum vitae of Fateha Hossain."
};
        ...
        <div className="flex-1 space-y-4">
          ...
          <div className="flex flex-wrap items-center gap-3 pt-2 text-sm font-medium">
            <a
              ...
              className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg bg-gradient-to-r from-teal-500 to-cyan-500 hover:from-teal-400 hover:to-cyan-400 text-slate-950 font-semibold shadow-md shadow-teal-500/20"
            >
