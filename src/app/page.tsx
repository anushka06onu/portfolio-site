...
export default function HomePage() {
  ...
  const pillarIcons = [
    ...
    <ShieldAlert key="2" className="w-4 h-4 text-cyan-400" />,
    <Server key="3" className="w-4 h-4 text-blue-400" />
  ];
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 py-8 sm:py-14 space-y-16 sm:space-y-24">
        ...
        <section className="space-y-8 pt-4 sm:pt-6" aria-labelledby="hero-heading">
          <div className="flex flex-col-reverse lg:flex-row items-start justify-between gap-8 lg:gap-12">
            <div className="flex-1 space-y-5">
              {/* Availability Status */}
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-[var(--border-color)] bg-[var(--surface)]/90 backdrop-blur-md text-xs font-mono text-[var(--text-muted)] shadow-sm">
              ...
              <div className="flex flex-wrap items-center gap-3 pt-2 font-mono text-xs">
                <a
                  ...
                  className="inline-flex items-center gap-1.5 px-4 py-2.5 rounded-lg bg-gradient-to-r from-teal-500 to-cyan-500 hover:from-teal-400 hover:to-cyan-400 text-slate-950 font-bold shadow-lg shadow-teal-500/20 hover:shadow-teal-500/30 transition-all"
                >
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1.5 px-4 py-2.5 rounded-lg border border-[var(--border-color)] bg-[var(--surface)] text-[var(--text-main)] hover:border-[var(--primary-accent)] hover:text-[var(--primary-accent)] hover:bg-[var(--surface-subtle)] transition-all"
                >
            ...
            {siteConfig.narrative.threePillars.map((pillar, idx) => (
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-xs font-bold font-mono text-[var(--text-main)] tracking-wide">
                    {pillar.title}
                  </h3>
                </div>
        ...
        <section id="research" className="space-y-6 scroll-mt-20" aria-labelledby="research-heading">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-3 border-b border-[var(--border-color)] pb-3">
            ...
            <Link
              href="/research"
              className="text-xs font-mono text-[var(--primary-accent)] hover:underline inline-flex items-center gap-1 font-semibold"
            >
            ...
            <div className="editorial-card p-6 space-y-3 flex flex-col justify-between">
              <div className="space-y-2">
                ...
                {siteConfig.education[0].distinction && (
                  <div className="flex items-start gap-2 p-2 rounded-lg bg-[var(--primary-accent-subtle)] border border-[var(--primary-accent)]/20 text-xs text-[var(--primary-accent)] font-medium">
              ...
              <div className="pt-2 border-t border-[var(--border-color)]">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full inline-flex items-center justify-center gap-2 px-3 py-2 rounded-lg border border-[var(--border-color)] bg-[var(--surface)] text-xs font-mono text-[var(--text-main)] hover:border-[var(--primary-accent)] hover:text-[var(--primary-accent)] hover:bg-[var(--surface-subtle)] transition-all font-medium"
                >
                  <FileDown className="w-3.5 h-3.5 text-[var(--primary-accent)]" />
